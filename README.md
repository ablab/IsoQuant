...
```
python3 isoquant.py -d nanopore --fusion --fastq ~/Thesis/real_data/SRR12048357_Ont.fastq --genedb ~/Thesis/refs/gencode.v49.chr_patch_hapl_scaff.annotation.db --reference ~/Thesis/refs/GRCh38.p14.genome.fa --output ~/Thesis/Isoquant/AML
```
