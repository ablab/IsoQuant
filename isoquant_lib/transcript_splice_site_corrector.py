...
def count_deletions_for_splice_site_locations(read_start: int,
                                              ...
                                              deletions: List[Tuple[int, int]],
                                              exons: List[Tuple[int, int]],
                                              splice_site_cases: Dict[int, dict],
    ...
    for splice_site_location, location_is_end in \
        ...
        if splice_site_data is None:
            splice_site_data = {
                'location_is_end': location_is_end,
                'deletions': {},
                'most_common_del': -1,
...
def correct_splice_site_errors(splice_site_cases: Dict[int, dict],
                               chr_record,
                               strand: str,
...
def generate_updated_exon_list(splice_site_cases: Dict[int, dict],
                               locations_with_errors: List[int],
