...
class ILPFlowCounter(AbstractCounter):
    ...
    def __init__(self, output_prefix, assignment_extractor, read_groups, read_counter,
                 all_features = None, grouped_format=GroupedOutputFormat.default):
        super().__init__(output_prefix, not read_groups)

        #  FIXME
        self.output_grouped_matrix = False
        self.output_grouped_linear = True
