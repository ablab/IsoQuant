...
class TestParseGroupingSpec:
    ...
    def test_parse_multicolumn_creates_separate_groupers(self):
        ...
        # Note: parse_grouping_spec appends "_chr_id" to the file path
        import tempfile
        temp_dir = tempfile.mkdtemp()
        base_file = os.path.join(temp_dir, "test_groups")
        chr_id = "chr1"
        chr_file = base_file + "_" + chr_id
        ...
        try:
            ...
            args = MockArgs()
            sample = MockSample(base_file)  # Use base file, function will append chr_id
            ...
            result = parse_grouping_spec(spec_string, args, sample, chr_id)
