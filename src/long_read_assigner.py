...
class LongReadAssigner:
    ...
    def detect_differences(self, read_id, read_intron_profile, read_split_exon_profile,
        ...
        # TODO add Jaccrd similarity instead of simple exon matching?
