...
class SampleData:
    ...
    def _init_paths(self):
        ...
        self.out_transcript_model_grouped_counts_tsv = self._make_path("expression_novel")
        self.out_transcript_model_ref_grouped_counts_tsv = self._make_path("expression")
        ...
        self.out_transcript_grouped_counts_tsv = self._make_path("expression_ref")
