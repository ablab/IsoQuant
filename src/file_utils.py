...
def merge_files(file_names, merged_file_name, counts=False, ignore_read_groups=True):
    ...
    if counts and ignore_read_groups:
        for file_name in file_names:
            with open(file_name + '.stats') as f:
                line = f.readline()
