            ...
            while loader.has_next():
                ...
                for read_assignment in assignment_storage:
                    ...
                    if len(read_assignment.isoform_matches) == 1:
                        ...
                        if isoform_match.assignmnet_type.is_consistent():
                        ...
                        for m in read_assignment.isoform_matches:
                            if m.assignmnet_type.is_consistent():
                                gene_ids.add(m.assigned_gene)
                                transcript_types.add(m.transcript_type)
                                polya_sites.add(m.polya_site)
                    ...
                    read_infos = [assignment_info.short()]
                    self.total_assignments += 1
                    self.add_stats_for_read(read_infos)

                    if barcoded and assigned:
                        continue
